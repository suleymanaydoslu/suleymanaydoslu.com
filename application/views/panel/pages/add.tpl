...
<section id="container" >
  <section id="main-content">
    <section class="wrapper" style="min-height:545px">
      <div class="row">
        <div class="col-sm-10 col-sm-offset-1 alert alert-info text-center"><strong>SAYFA EKLE</strong></div>
            ...
            <div class="panel-body">
              <form class="form-horizontal" id="default" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="col-lg-2 control-label">Sayfa Adı:</label>
                    <div class="col-lg-10">
                ...
                <input type="submit" class="finish btn btn-danger" value="EKLE"/>
              </form>
            </div>
          </section>
