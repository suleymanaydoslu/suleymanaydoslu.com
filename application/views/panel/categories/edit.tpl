    ...
    <section id="container">
        <section id="main-content">
            <section class="wrapper" style="min-height:545px">
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1 alert alert-info text-center"><strong>KATEGORİ DÜZENLE</strong></div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" id="default" action="{base_url('panel/category/update')}/{$category->id}" method="post">
